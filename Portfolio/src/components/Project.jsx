...
function Project() {
  return (
    <>
    <div className='projMaster flex flex-wrap flex-col h-[800px] w-[100%] mt-[15px] text-white border-1  '>
        ...
        <div className='projStats flex flex-wrap justify-around border-1 p-[10px] m-[10px]'>
          ...
          <div className="liveDemo flex w-[100%] p-[10px] h-[90px]">
            <a className="liveDemoButton" href='https://github.com/bhavyasachula/agentic-billbot-pro' target='_blank'>
              ...
              <div className="content"><svg width="25px" height="25px" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
 ...
 <path d="M6 18L18 6M18 6H10M18 6V14" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/></svg></div>
      ...
      <div className="innerSection2 flex flex-col justify-evenly h-[100%] p-[10px] border-1">
        ...
        <div className="content p-[10px]">01</div>{/* we need to add more react usable code for not doing u just have to change the value and you are */}
